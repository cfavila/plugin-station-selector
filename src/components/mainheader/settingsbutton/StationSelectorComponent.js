...
// update CSS for themed style support
const StyledFormInput = withStyles((theme) => {
  console.log('============');
        ...
        <FormControl component='fieldset'>
          ...
          >
            <StyledFormInput
              value='client'
              control={
                <StyledRadio color='primary' inputProps={{ id: 'client' }} />
              }
              label='webRTC'
            />{' '}
            <StyledFormInput
              value='pstn'
              control={
                <StyledRadio color='primary' inputProps={{ id: 'pstn' }} />
              }
              label='PSTN'
            />
            <StyledFormInput
              value='sip'
              control={
                <StyledRadio color='primary' inputProps={{ id: 'sip' }} />
              }
              label='SIP'
            />
          </RadioGroup>
